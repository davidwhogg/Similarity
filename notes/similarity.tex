...
\begin{eqnarray}
V &\equiv& R\cdot\Lambda\cdot\tra{R} \quad ,
\end{eqnarray}
...
\ln p(a,b\given y_1,y_2) &=&
  -\frac{1}{2}\,\tra{[a+b]}\cdot\inv{\Lambda}\cdot [a+b]
  -\frac{1}{2}\,\tra{[a-b]}\cdot\inv{\Lambda}\cdot [a-b] \nonumber\\
  &&
  -\frac{1}{2}\,\tra{[y_1-R\cdot(a+b)-\mu]}\cdot\inv{C_1}\cdot [y_1-R\cdot(a+b)-\mu] \nonumber\\
  &&
  -\frac{1}{2}\,\tra{[y_2-R\cdot(a-b)-\mu]}\cdot\inv{C_2}\cdot [y_2-R\cdot(a-b)-\mu] \nonumber\\
  &&
  + Z \quad ,
\end{eqnarray}
...
\ln p(b\given y_1,y_2) &=&
  -\frac{1}{2}\,\tra{[b-\beta]}\cdot\inv{W}\cdot [b-\beta]
  -\frac{1}{2}\,\ln\det{2\pi\,W} \\
\inv{W} &\equiv&
  2\,\inv{\Lambda} + 2\,\tra{R}\cdot\inv{C}\cdot R \\
\beta &\equiv&
  W\cdot\tra{R}\cdot\inv{C}\cdot [y_1 - y_2]
\quad ,
\end{eqnarray}
...
with the operator $W\cdot\tra{R}\cdot\inv{C}$ projecting the
...
\begin{eqnarray}
Q &\equiv&
  -\frac{1}{2}\,\tra{\beta}\cdot\inv{W}\cdot\beta
...
and the prior variance is full-rank (so $\tra{R}\cdot R\equiv R\cdot\tra{R}$ is the
identity).
