...
% - possibly refer to the refractory elements things as an example of $W$?
% - give more context about what happens if you have different Vs for different pairs? Do you modify the threshold?
% - give more context about how false positive and false negative rates vary with measurement uncertainty.
...
in the libraries of astrophysicists.\footnote{But I must admit that I didn't
  look very hard. If you want to explore these ideas more online, you could search
  terms like ``p-value'', ``\acronym{ANOVA}'', and ``Bayesian inference''.}
