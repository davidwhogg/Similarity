...
\noindent
\textbf{David W. Hogg%
\footnote{For many of the ideas and some of the presentation in this document, I
...
One final note before we start: This \documentname\ does not contain,
...
\footnote{It is my view that the only sense in which a data analysis
  can be said to be \emph{correct} or (heaven forbid)
  ``\emph{optimal}'' (yes, I am using \emph{scare quotes}) is if there
  is a sufficiently clear set of explicitly stated assumptions such
  that the method can be shown to be correct or optimal \emph{under
